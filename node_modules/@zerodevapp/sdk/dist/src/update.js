...
const contracts_2 = require("@zerodevapp/contracts");
const contracts_3 = require("@zerodevapp/contracts");
...
class UpdateController {
    ...
    async checkUpdate(latestAccountFactoryAddr) {
        try {
            ...
            const manager = contracts_3.EIP4337Manager__factory.connect(latestManagerAddr, this.signer); // get manager address from factory
    ...
    async update() {
        ...
        if (this.managerUpdateInfo) {
            ...
            const manager = contracts_3.EIP4337Manager__factory.connect(newManager, this.signer);
            batch.push({
                to: manager.address,
        ...
        if (this.singletonUpdateInfo) {
            const updateSingleton = contracts_2.UpdateSingleton__factory.connect(constants.UPDATE_SINGLETON_ADDRESS, this.signer);
            batch.push({
